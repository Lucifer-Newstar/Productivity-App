...
const root=path.resolve(__dirname,"..");const habits=fs.readFileSync(path.join(root,"components/Habits.tsx"),"utf8"),setup=fs.readFileSync(path.join(root,"components/NotificationCenter.tsx"),"utf8");
