...
check("session-only voice audio has download and persistence disclosure",voice.includes("download =")&&voice.includes("Audio is session-only")&&voice.includes("transcript retained"));
