...
import { bmrMifflin, tdee, waterGoalMl, proteinTargetG, bmi, formatMl, formatKcal } from "../../lib/healthAnalytics";
      ...
      <div className="hlth-grid">
        <div className="hlth-card" style={{ gridColumn: "1 / -1" }}>
          ...
          <p className="hlth-subtle" style={{ fontSize: 13, margin: 0 }}>
            {today}. Wave 1 online — shell, theme, nav &amp; bridge plumbing.
            Section dashboards ship in subsequent waves. Your profile defaults
            are tuned for a 20yo lifter in Chennai; adjust in <strong style={{ color: "var(--hlth-fg)" }}>§08 Lab</strong>.
          </p>
        </div>
        ...
        <div className="hlth-card" style={{ gridColumn: "1 / -1" }}>
          ...
          <div className="hlth-grid" style={{ marginTop: 8 }}>
            {[
              ...
              ["03", "Somnium",    "Wave 3 (sleep, bank)"],
              ["04", "Soma",       "Wave 4 (measurements, BF%)"],
              ["05", "Apothecary", "Wave 3 (supplements)"],
