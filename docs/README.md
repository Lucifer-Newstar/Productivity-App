...
| [`reports/WINDOWS-PACKAGING-FOUNDATION-2026-08-19.md`](reports/WINDOWS-PACKAGING-FOUNDATION-2026-08-19.md) | Installer/portable implementation and remaining physical-host matrix |
...
- [`guides/WINDOWS-INSTALLATION.md`](guides/WINDOWS-INSTALLATION.md) — installer, portable ZIP, data and offline operation.
