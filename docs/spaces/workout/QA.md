...
_Current regression baseline (2026-08-18): TypeScript, ESLint and production build pass on the stable product baseline; all Workout routes are included in route smoke. `docs/quality/qa/TEST-REPORT.md` remains the historical dedicated Workout report._
