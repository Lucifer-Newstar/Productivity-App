...
_Current regression baseline (2026-08-18): TypeScript, ESLint and production build pass on the stable product baseline; all Career routes are included in route smoke. Historical module/build details below retain their original measurements._
