...
- **v0.1.1 Deterministic Core Today interpretation:** trusted routing, zero-tool provider interpretation, security controls, deterministic/mock evaluation and live integration accepted. Interpreter-model evaluation design is frozen with execution disabled.
