...
- **v0.1.1 Deterministic Core Today interpretation:** trusted routing, zero-tool provider interpretation, security controls and deterministic/mock evaluation implemented; frozen for integration review.
