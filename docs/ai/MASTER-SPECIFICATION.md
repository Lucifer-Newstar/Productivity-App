...
- **v0.1.1 Deterministic Core Today interpretation:** trusted routing, zero-tool provider interpretation, security controls, deterministic/mock evaluation and live integration accepted. Interpreter-model corpus/harness implemented with candidates and execution disabled.
